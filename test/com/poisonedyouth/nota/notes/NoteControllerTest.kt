...
class NoteControllerTest {
    ...
    fun `listNotes should return list view with notes`() {
        ...
        val notes = listOf(
            NoteDto(id = 1L, title = "Note 1", content = "Content 1", createdAt = now, updatedAt = now, archived = false),
            NoteDto(id = 2L, title = "Note 2", content = "Content 2", createdAt = now, updatedAt = now, archived = false),
        )
