...
class ActivityEventIntegrationTest
    ...
    constructor(
        ...
        @Test
        fun `publishLoginEvent should create activity log entry`() = runBlocking {
            // When
        ...
        @Test
        fun `publishCreateNoteEvent should create activity log entry`() = runBlocking {
            // Given
            val noteId = 42L
        ...
        @Test
        fun `publishUpdateNoteEvent should create activity log entry`() = runBlocking {
            // Given
            val noteId = 43L
        ...
        @Test
        fun `publishArchiveNoteEvent should create activity log entry`() = runBlocking {
            // Given
            val noteId = 44L
        ...
        @Test
        fun `publishShareNoteEvent should create activity log entry`() = runBlocking {
            // Given
            val noteId = 45L
        ...
        @Test
        fun `multiple events should create multiple activity log entries`() = runBlocking {
            // When
            activityEventPublisher.publishLoginEvent(testUser.id!!)
        ...
        @Test
        fun `event publishing should be resilient to async failures`() = runBlocking {
