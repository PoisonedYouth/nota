...
class ActivityEventPublisher(
    ...
    fun publishCreateNoteEvent(userId: Long, noteId: Long, noteTitle: String) {
        eventPublisher.publishEvent(CreateNoteEvent(userId, noteId, noteTitle))
    }

    fun publishUpdateNoteEvent(userId: Long, noteId: Long, noteTitle: String) {
        eventPublisher.publishEvent(UpdateNoteEvent(userId, noteId, noteTitle))
    }

    fun publishArchiveNoteEvent(userId: Long, noteId: Long, noteTitle: String) {
        eventPublisher.publishEvent(ArchiveNoteEvent(userId, noteId, noteTitle))
    }

    fun publishShareNoteEvent(userId: Long, noteId: Long, noteTitle: String, sharedWithUsername: String) {
